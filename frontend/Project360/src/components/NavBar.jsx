...
function NavBar() {
  return (
    <div className="flex flex-row bg-gradient-to-t from-neutral-800 to-black h-20 w-screen text-gray-50 font-semibold items-center">
      ...
      <div className="flex flex-row items-center ml-auto gap-10 mr-7">
        ...
        <Button
          className={
            "text-indigo-500 ease-in-out duration-75 hover:bg-gradient-to-br from-blue-300 via-indigo-400 to-indigo-800 hover:text-gray-50"
          }
          text={"Sign Up"}
        />
      </div>
